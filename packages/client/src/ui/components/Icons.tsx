...
export function ChatIcon({ size = 24 }: IconProps) {
  return (
    ...
    >
      <path
        d="M20 2H4C3.46957 2 2.96086 2.21071 2.58579 2.58579C2.21071 2.96086 2 3.46957 2 4V22L6 18H20C20.5304 18 21.0391 17.7893 21.4142 17.4142C21.7893 17.0391 22 16.5304 22 16V4C22 3.46957 21.7893 2.96086 21.4142 2.58579C21.0391 2.21071 20.5304 2 20 2ZM6 9H18V11H6M14 14H6V12H14M18 8H6V6H18"
        fill="currentColor"
      />
    </svg>
  );
...
export function VRIcon({ size = 24, ..._props }) {
  return (
    <svg
      width={size}
      height={size}
...
export function MicOffIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CircleUpIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HandIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ChevronDoubleUpIcon({ size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
