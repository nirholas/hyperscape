                ...
                <div className="space-y-1">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        background: `linear-gradient(to right, ${COLORS.ACCENT} 0%, ${COLORS.ACCENT} ${((uiScale - 0.6) / 1.0) * 100}%, rgba(242, 208, 138, 0.2) ${((uiScale - 0.6) / 1.0) * 100}%, rgba(242, 208, 138, 0.2) 100%)`,
                      }}
                    />
                  </div>
                  ...
                  {(() => {
                    const roles = (player?.data?.roles as string[] | undefined) || [];
                ...
                <div className="space-y-1">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-1 rounded-full appearance-none cursor-pointer"
                      style={{
                        background: `linear-gradient(to right, ${COLORS.ACCENT} 0%, ${COLORS.ACCENT} ${(music / 2) * 100}%, rgba(242, 208, 138, 0.2) ${(music / 2) * 100}%, rgba(242, 208, 138, 0.2) 100%)`,
                      }}
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-1 rounded-full appearance-none cursor-pointer"
                      style={{
                        background: `linear-gradient(to right, ${COLORS.ACCENT} 0%, ${COLORS.ACCENT} ${(sfx / 2) * 100}%, rgba(242, 208, 138, 0.2) ${(sfx / 2) * 100}%, rgba(242, 208, 138, 0.2) 100%)`,
                      }}
                    />
                  </div>
