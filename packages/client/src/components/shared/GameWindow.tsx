...
export function GameWindow({ title, onClose, defaultX, defaultY, windowId = 'default', children, fitContent = false, zIndex = 1000, onFocus }: GameWindowProps) {
    ...
    return (
      <>
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, rgba(20, 15, 10, 0.75) 0%, rgba(15, 10, 5, 0.85) 100%)',
            ...
            boxShadow: '0 -10px 30px rgba(0, 0, 0, 0.7), 0 -2px 12px rgba(139, 69, 19, 0.3), inset 0 1px 0 rgba(242, 208, 138, 0.1), inset 0 -1px 0 rgba(0, 0, 0, 0.5)',
            maxHeight: 'min(33vh, calc(100vh - var(--mobile-chat-offset, 0px) - 100px))',
            bottom: collapsed ? 0 : 'var(--mobile-chat-offset, 0px)',
            paddingBottom: collapsed ? 'calc(var(--mobile-chat-offset, 0px) + env(safe-area-inset-bottom))' : 'env(safe-area-inset-bottom)',
            zIndex: zIndex,
          }}
          onClick={onFocus}
        >
          ...
          <div
            ...
            style={{
              background: 'linear-gradient(180deg, rgba(30, 20, 10, 0.8) 0%, rgba(20, 15, 10, 0.6) 100%)',
              borderBottom: '1px solid rgba(139, 69, 19, 0.5)',
              boxShadow: 'inset 0 1px 0 rgba(242, 208, 138, 0.15), inset 0 -1px 0 rgba(0, 0, 0, 0.5)',
          ...
          >
            ...
            <div className="flex justify-center mb-1">
              <div className="w-8 h-0.5 rounded-full" style={{
                background: 'linear-gradient(90deg, transparent, rgba(242, 208, 138, 0.6), transparent)',
            ...
            <div className="flex items-center justify-between">
              <div className="font-semibold text-sm tracking-wider" style={{
                color: '#f2d08a',
                textShadow: '0 1px 2px rgba(0, 0, 0, 0.8), 0 0 8px rgba(242, 208, 138, 0.3)',
              ...
              <button
                ...
                style={{
                  ...
                  color: '#f2d08a',
                  boxShadow: '0 2px 4px rgba(0, 0, 0, 0.6), inset 0 1px 0 rgba(242, 208, 138, 0.2)',
          ...
          {/* Content */}
          <div className="p-2.5 overflow-y-auto" style={{ maxHeight: 'calc(min(33vh, calc(100vh - var(--mobile-chat-offset, 0px) - 100px)) - 50px)' }}>
            {children}
          </div>
        </div>
      </>
  ...
  const initialHeight = typeof dimensions.maxHeight === 'string'
  ...
  const getWindowSize = () => {
    ...
    return {
      width: fitContent ? Math.min(400, safeWidth) : (isTablet ? Math.min(window.innerWidth * 0.9, maxWidth) : Math.min(dimensions.width, safeWidth)),
  ...
  return (
      ...
      dragHandle={
        <div
          ...
          style={{
            ...
            boxShadow: 'inset 0 1px 0 rgba(242, 208, 138, 0.2), inset 0 -1px 0 rgba(0, 0, 0, 0.6)',
          }}
        >
          <div className="font-semibold text-sm tracking-wider" style={{
            color: '#f2d08a',
    ...
    >
      <div className={fitContent ? "p-3 overflow-y-auto flex flex-col flex-1" : "p-3 overflow-y-auto flex-1"}>
        {children}
      </div>
    </DraggableWindow>
  )
