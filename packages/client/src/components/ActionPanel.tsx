...
export function ActionPanel({ items, onItemUse }: ActionPanelProps) {
  ...
  const slotSize = isMobile ? 'clamp(2rem, 10vw, 2.5rem)' : 'clamp(2.5rem, 5vw, 3rem)'
  const iconSize = isMobile ? 'clamp(0.875rem, 2vw, 1rem)' : 'clamp(1rem, 2vw, 1.25rem)'
  const arrowSize = isMobile ? 'clamp(0.625rem, 1.5vw, 0.75rem)' : 'clamp(0.75rem, 1.5vw, 0.875rem)'

  return (
    <div className="flex items-center" style={{ gap: 'clamp(0.25rem, 0.5vw, 0.375rem)' }}>
      {/* Pagination Controls */}
      <div className="flex flex-col" style={{ gap: 'clamp(0.125rem, 0.25vw, 0.1875rem)' }}>
        <button
          ...
          style={{
            ...
            borderColor: currentPage === 0 ? 'rgba(139, 69, 19, 0.3)' : 'rgba(139, 69, 19, 0.6)',
        ...
        <button
          ...
          style={{
            ...
            background: currentPage >= totalPages - 1
              ...
              : 'linear-gradient(135deg, rgba(30, 20, 10, 0.9) 0%, rgba(20, 15, 10, 0.95) 100%)',
            backdropFilter: 'blur(8px)',
            borderColor: currentPage >= totalPages - 1 ? 'rgba(139, 69, 19, 0.3)' : 'rgba(139, 69, 19, 0.6)',
            ...
            >
              ...
              {item && item.quantity > 1 && (
                <div
                  ...
                  style={{
                    ...
                    fontSize: isMobile ? 'clamp(0.375rem, 1vw, 0.438rem)' : 'clamp(0.438rem, 1vw, 0.5rem)',
              ...
              {!isEmpty && (
                <div
                  ...
                  style={{
                    background: 'radial-gradient(circle at center, rgba(242, 208, 138, 0.15) 0%, transparent 70%)',
                  }}
                />
              )}
              ...
              <div
                ...
                style={{
                  color: '#f2d08a',
                  fontSize: isMobile ? 'clamp(0.375rem, 0.9vw, 0.438rem)' : 'clamp(0.438rem, 0.9vw, 0.5rem)',
