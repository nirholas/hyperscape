...
export function AccountPanel({ world }: AccountPanelProps) {
  ...
  return (
    <div className="h-full overflow-y-auto noscrollbar p-1">
      {/* Bento Grid Layout */}
      <div className="grid gap-1.5 auto-rows-min" style={{
        ...
        <div
          ...
          style={{
            gridColumn: 'span 6',
            background: 'linear-gradient(135deg, rgba(20, 15, 10, 0.85) 0%, rgba(25, 20, 15, 0.75) 100%)',
            borderColor: authenticated ? 'rgba(34, 197, 94, 0.4)' : 'rgba(242, 208, 138, 0.3)',
            border: '1px solid',
              ...
              <div className="flex-1">
                <div className="flex items-center gap-1.5 mb-1">
                  <div
                    ...
                    style={{ backgroundColor: authenticated ? '#22c55e' : '#9ca3af' }}
                  />
                  <span className="text-[8px] uppercase tracking-widest" style={{ color: 'rgba(242, 208, 138, 0.5)' }}>
                    {authenticated ? 'Connected' : 'Guest'}
                  </span>
                </div>
                <div className="text-base font-bold mb-0.5" style={{
                  color: '#f2d08a',
                ...
                {authenticated && email && (
                  <div className="text-[8px] font-mono" style={{ color: 'rgba(242, 208, 138, 0.5)' }}>
                    {email}
                  </div>
                )}
              </div>
        ...
        {authenticated && userId && (
          <div
            ...
            style={{
              gridColumn: 'span 3',
              background: 'linear-gradient(135deg, rgba(242, 208, 138, 0.08) 0%, rgba(139, 69, 19, 0.08) 100%)',
              border: '1px solid rgba(242, 208, 138, 0.2)',
            }}
          >
            <div className="text-[7px] uppercase tracking-wide mb-0.5" style={{ color: 'rgba(242, 208, 138, 0.4)' }}>
              User ID
            </div>
            <div className="font-mono text-[9px]" style={{ color: 'rgba(242, 208, 138, 0.85)' }}>
        ...
        {authenticated && walletAddress && (
          ...
          >
            <div className="text-[7px] uppercase tracking-wide mb-0.5" style={{ color: 'rgba(34, 197, 94, 0.5)' }}>
              💎 Wallet
            </div>
            <div className="font-mono text-[9px]" style={{ color: 'rgba(34, 197, 94, 0.9)' }}>
        ...
        {authenticated && farcasterFid && (
          ...
          >
            <div className="text-[7px] uppercase tracking-wide mb-0.5" style={{ color: 'rgba(168, 85, 247, 0.5)' }}>
              🎭 Farcaster
            </div>
            <div className="font-mono text-[9px]" style={{ color: 'rgba(168, 85, 247, 0.95)' }}>
              FID {farcasterFid}
            </div>
          </div>
        )}
        ...
        {[
          ...
          { label: 'Persistent', enabled: authenticated, icon: '💾', col: 'span 3' },
          { label: 'Recovery', enabled: authenticated, icon: '🔐', col: 'span 3' },
          { label: 'Social', enabled: !!farcasterFid, icon: '🌐', col: 'span 3' },
        ].map((feature, i) => (
          <div
            key={i}
          ...
          >
            <div className="flex items-center gap-1">
              ...
              <span className="text-[8px] flex-1" style={{
                color: feature.enabled ? 'rgba(242, 208, 138, 0.9)' : 'rgba(242, 208, 138, 0.4)'
              }}>
                {feature.label}
              </span>
              <span className="text-[9px]" style={{ color: feature.enabled ? '#22c55e' : '#6b7280' }}>
                {feature.enabled ? '✓' : '○'}
              </span>
            </div>
          </div>
        ...
        {!authenticated && (
          ...
          >
            <div className="flex items-start gap-1.5">
              ...
              <div className="flex-1">
                <div className="text-[9px] font-semibold mb-0.5" style={{ color: 'rgba(251, 191, 36, 0.9)' }}>
                  Guest Mode Active
                </div>
                <div className="text-[7px]" style={{ color: 'rgba(242, 208, 138, 0.6)' }}>
                  Progress won't be saved. Configure Privy in .env for authentication.
                </div>
              </div>
            </div>
          </div>
