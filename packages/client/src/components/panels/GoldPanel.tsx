  ...
  return (
    ...
    >
      <div className="flex justify-between items-center mb-2">
        <h3 className="text-sm font-bold" style={{ color: "#f2d08a" }}>
          Gold
        </h3>
      </div>
      ...
      <div className="space-y-2">
        ...
        >
          ...
          <span className="font-bold" data-testid="gold-ingame">
        ...
        >
          ...
          <span className="font-bold" data-testid="gold-claimed">
        ...
        >
          <span>Claimable:</span>
          <span className="font-bold" data-testid="gold-claimable">
            {(coins - claimed).toLocaleString()}
          </span>
        </div>
