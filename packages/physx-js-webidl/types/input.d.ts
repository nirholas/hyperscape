...
declare module PhysX {
  ...
  class BaseVehicleParams {
    constructor();
    transformAndScale(
      srcFrame: PxVehicleFrame,
      trgFrame: PxVehicleFrame,
      srcScale: PxVehicleScale,
      trgScale: PxVehicleScale,
    ): BaseVehicleParams;
    isValid(): boolean;
  ...
  class DirectDriveVehicle extends PhysXActorVehicle {
    ...
    initialize(
      ...
      defaultMaterial: PxMaterial,
      addPhysXBeginEndComponents?: boolean,
    ): boolean;
    initComponentSequence(addPhysXBeginEndComponents: boolean): void;
  ...
  class NativeArrayHelpers {
    ...
    static getContactPairHeaderAt(
      base: PxContactPairHeader,
      index: number,
    ): PxContactPairHeader;
    static getControllerAt(base: PxController, index: number): PxController;
    static getControllerShapeHitAt(
      base: PxControllerShapeHit,
      index: number,
    ): PxControllerShapeHit;
    static getControllersHitAt(
      base: PxControllersHit,
      index: number,
    ): PxControllersHit;
    static getControllerObstacleHitAt(
      base: PxControllerObstacleHit,
      index: number,
    ...
    static getDebugTriangleAt(
      base: PxDebugTriangle,
      index: number,
    ): PxDebugTriangle;
  ...
  class PassThroughFilterShader extends PxSimulationFilterShader {
    filterShader(
      attributes0: number,
      filterData0w0: number,
      filterData0w1: number,
      filterData0w2: number,
      filterData0w3: number,
      attributes1: number,
      filterData1w0: number,
      filterData1w1: number,
      filterData1w2: number,
      filterData1w3: number,
    ): number;
  ...
  class PhysXIntegrationParams {
    ...
    isValid(axleDesc: PxVehicleAxleDescription): boolean;
    create(
      axleDesc: PxVehicleAxleDescription,
      roadQueryFilterData: PxQueryFilterData,
      roadQueryFilterCallback: PxQueryFilterCallback,
      materialFrictions: PxVehiclePhysXMaterialFriction,
      nbMaterialFrictions: number,
      defaultFriction: number,
      physxActorCMassLocalPose: PxTransform,
      actorGeometry: PxGeometry,
  ...
  class PxArticulationFixedTendon extends PxArticulationTendon {
    createTendonJoint(
      ...
      axis: PxArticulationAxisEnum,
      coefficient: number,
      recipCoefficient: number,
  ...
  class PxArticulationSpatialTendon extends PxArticulationTendon {
    createAttachment(
      parent: PxArticulationAttachment,
      coefficient: number,
  ...
  class PxCollectionExt {
    static releaseObjects(
      collection: PxCollection,
      releaseExclusiveShapes?: boolean,
    ): void;
    static remove(
      collection: PxCollection,
      concreteType: number,
  ...
  class PxGjkQuery {
    static proximityInfo(
      ...
      result: PxGjkQueryProximityInfoResult,
    ): boolean;
    static raycast(
      shape: Support,
      pose: PxTransform,
      ...
      unitDir: PxVec3,
      maxDist: number,
      result: PxGjkQueryRaycastResult,
    ): boolean;
    static overlap(
      a: Support,
      b: Support,
  ...
  class PxHeightField extends PxRefCounted {
    ...
    modifySamples(
      startCol: number,
      startRow: number,
      subfieldDesc: PxHeightFieldDesc,
      shrinkBounds?: boolean,
    ): boolean;
    getNbRows(): number;
    getNbColumns(): number;
  ...
  class PxMeshOverlapUtil {
    ...
    findOverlap(
      geom: PxGeometry,
      geomPose: PxTransform,
      meshGeom: PxTriangleMeshGeometry,
      meshPose: PxTransform,
    ): number;
  ...
  class PxRigidBodyExt {
    static updateMassAndInertia(
      body: PxRigidBody,
      density: number,
      massLocalPose?: PxVec3,
      includeNonSimShapes?: boolean,
    ): boolean;
    static setMassAndUpdateInertia(
      body: PxRigidBody,
      mass: number,
      massLocalPose?: PxVec3,
      includeNonSimShapes?: boolean,
    ): boolean;
    static addForceAtPos(
      body: PxRigidBody,
      force: PxVec3,
      pos: PxVec3,
      mode?: PxForceModeEnum,
    ...
    static addLocalForceAtLocalPos(
      body: PxRigidBody,
      force: PxVec3,
      pos: PxVec3,
      mode?: PxForceModeEnum,
    ...
    static computeVelocityDeltaFromImpulse(
      body: PxRigidBody,
      impulsiveForce: PxVec3,
      impulsiveTorque: PxVec3,
      deltaLinearVelocity: PxVec3,
      deltaAngularVelocity: PxVec3,
    ): void;
    static computeVelocityDeltaFromImpulse(
      body: PxRigidBody,
      globalPose: PxTransform,
      point: PxVec3,
      impulse: PxVec3,
      invMassScale: number,
      invInertiaScale: number,
      deltaLinearVelocity: PxVec3,
      deltaAngularVelocity: PxVec3,
    ): void;
    static computeLinearAngularImpulse(
      body: PxRigidBody,
      globalPose: PxTransform,
      point: PxVec3,
      impulse: PxVec3,
      invMassScale: number,
      invInertiaScale: number,
      linearImpulse: PxVec3,
      angularImpulse: PxVec3,
    ): void;
  }
  ...
  class PxScene extends PxSceneSQSystem {
    ...
    simulate(
      ...
      scratchMemBlock?: unknown,
      scratchMemBlockSize?: number,
    ...
    setVisualizationParameter(
      param: PxVisualizationParameterEnum,
      value: number,
    ): boolean;
    ...
    getBroadPhaseRegions(
      userBuffer: PxBroadPhaseRegionInfo,
      bufferSize: number,
      startIndex?: number,
    ): number;
    addBroadPhaseRegion(
      region: PxBroadPhaseRegion,
      populateRegion?: boolean,
    ): number;
  ...
  class PxSceneSQSystem extends PxSceneQuerySystemBase {
    ...
    forceDynamicTreeRebuild(
      rebuildStaticStructure: boolean,
      rebuildDynamicStructure: boolean,
    ): void;
  ...
  class PxSerialization {
    static isSerializable(
      collection: PxCollection,
      sr: PxSerializationRegistry,
      externalReferences?: PxCollection,
    ): boolean;
    static complete(
      collection: PxCollection,
      sr: PxSerializationRegistry,
      exceptFor?: PxCollection,
      followJoints?: boolean,
    ): void;
    static createSerialObjectIds(collection: PxCollection, base: number): void;
    static createCollectionFromXml(
      inputData: PxInputData,
      params: PxCookingParams,
      sr: PxSerializationRegistry,
      externalRefs?: PxCollection,
    ): PxCollection;
    static createCollectionFromBinary(
      memBlock: unknown,
      sr: PxSerializationRegistry,
      externalRefs?: PxCollection,
    ): PxCollection;
    static serializeCollectionToXml(
      outputStream: PxOutputStream,
      collection: PxCollection,
      sr: PxSerializationRegistry,
      params?: PxCookingParams,
      externalRefs?: PxCollection,
    ): boolean;
    static serializeCollectionToBinary(
      outputStream: PxOutputStream,
      collection: PxCollection,
      sr: PxSerializationRegistry,
      externalRefs?: PxCollection,
    ...
    static createSerializationRegistry(
      physics: PxPhysics,
  ...
  class PxShapeExt {
    ...
    static overlap(
      shape: PxShape,
      actor: PxRigidActor,
      otherGeom: PxGeometry,
      otherGeomPose: PxTransform,
    ): boolean;
    static sweep(
      shape: PxShape,
      actor: PxRigidActor,
  ...
  class PxSimulationEventCallbackImpl {
    ...
    onContact(
      pairHeader: PxContactPairHeader,
      pairs: PxContactPair,
      nbPairs: number,
    ): void;
  ...
  class PxTetMaker {
    static createConformingTetrahedronMesh(
      triangleMesh: PxSimpleTriangleMesh,
      outVertices: PxArray_PxVec3,
      outTetIndices: PxArray_PxU32,
      validate: boolean,
      volumeThreshold: number,
    ): boolean;
    static createVoxelTetrahedronMesh(
      tetMesh: PxTetrahedronMeshDesc,
      numVoxelsAlongLongestBoundingBoxAxis: number,
      outVertices: PxArray_PxVec3,
      outTetIndices: PxArray_PxU32,
    ): boolean;
    static createVoxelTetrahedronMeshFromEdgeLength(
      tetMesh: PxTetrahedronMeshDesc,
      voxelEdgeLength: number,
      outVertices: PxArray_PxVec3,
      outTetIndices: PxArray_PxU32,
    ): boolean;
    static validateTriangleMesh(
      triangleMesh: PxSimpleTriangleMesh,
      minVolumeThreshold: number,
      minTriangleAngleRadians: number,
    ): PxTriangleMeshAnalysisResults;
    static validateTetrahedronMesh(
      points: PxBoundedData,
      tetrahedra: PxBoundedData,
      minTetVolumeThreshold: number,
    ): PxTetrahedronMeshAnalysisResults;
    static simplifyTriangleMesh(
      inputVertices: PxArray_PxVec3,
      inputIndices: PxArray_PxU32,
      targetTriangleCount: number,
      maximalEdgeLength: number,
      outputVertices: PxArray_PxVec3,
      outputIndices: PxArray_PxU32,
      vertexMap?: PxArray_PxU32,
      edgeLengthCostWeight?: number,
      flatnessDetectionThreshold?: number,
      projectSimplifiedPointsOnInputMeshSurface?: boolean,
      outputVertexToInputTriangle?: PxArray_PxU32,
      removeDisconnectedPatches?: boolean,
    ): void;
    static remeshTriangleMesh(
      inputVertices: PxArray_PxVec3,
      inputIndices: PxArray_PxU32,
    ...
    static createTreeBasedTetrahedralMesh(
      inputVertices: PxArray_PxVec3,
      inputIndices: PxArray_PxU32,
      useTreeNodes: boolean,
      outputVertices: PxArray_PxVec3,
      outputIndices: PxArray_PxU32,
      volumeThreshold: number,
    ): void;
    static createRelaxedVoxelTetrahedralMesh(
      inputVertices: PxArray_PxVec3,
      inputIndices: PxArray_PxU32,
      outputVertices: PxArray_PxVec3,
      outputIndices: PxArray_PxU32,
      resolution: number,
      numRelaxationIterations?: number,
      relMinTetVolume?: number,
    ): void;
    static detectTriangleIslands(
      triangles: PxI32ConstPtr,
      numTriangles: number,
      islandIndexPerTriangle: PxArray_PxU32,
    ): void;
    static findLargestIslandId(
      islandIndexPerTriangle: PxU32ConstPtr,
      numTriangles: number,
    ): number;
  }
  ...
  class PxTetrahedronMeshDesc {
    constructor();
    constructor(
      meshVertices: PxArray_PxVec3,
      meshTetIndices: PxArray_PxU32,
      meshFormat?: PxTetrahedronMeshFormatEnum,
      numberOfTetsPerHexElement?: number,
    );
    isValid(): boolean;
  ...
  class PxTetrahedronMeshExt {
    static findTetrahedronContainingPoint(
      mesh: PxTetrahedronMesh,
      point: PxVec3,
      bary: PxVec4,
      tolerance: number,
    ): number;
    static findTetrahedronClosestToPoint(
      mesh: PxTetrahedronMesh,
      point: PxVec3,
      bary: PxVec4,
    ): number;
    static createPointsToTetrahedronMap(
      tetMeshVertices: PxArray_PxVec3,
      tetMeshIndices: PxArray_PxU32,
      pointsToEmbed: PxArray_PxVec3,
      barycentricCoordinates: PxArray_PxVec4,
      tetLinks: PxArray_PxU32,
    ): void;
    static extractTetMeshSurface(
      mesh: PxTetrahedronMesh,
      surfaceTriangles: PxArray_PxU32,
      surfaceTriangleToTet?: PxArray_PxU32,
      flipTriangleOrientation?: boolean,
    ): void;
  }
  ...
  class PxTopLevelFunctions {
    ...
    static setupPassThroughFilterShader(
      sceneDesc: PxSceneDesc,
      filterShader: PassThroughFilterShader,
    ): void;
    static CreateControllerManager(
      scene: PxScene,
    ...
    static CreateFoundation(
      ...
      errorCallback: PxErrorCallback,
    ): PxFoundation;
    static CreatePhysics(
      version: number,
      foundation: PxFoundation,
      params: PxTolerancesScale,
      pvd?: PxPvd,
      omniPvd?: PxOmniPvd,
    ): PxPhysics;
    static DefaultCpuDispatcherCreate(
      numThreads: number,
    ...
    static D6JointCreate(
      physics: PxPhysics,
      actor0: PxRigidActor,
      localFrame0: PxTransform,
      actor1: PxRigidActor,
      localFrame1: PxTransform,
    ): PxD6Joint;
    static DistanceJointCreate(
      physics: PxPhysics,
      actor0: PxRigidActor,
      localFrame0: PxTransform,
      actor1: PxRigidActor,
    ...
    static RackAndPinionJointCreate(
      physics: PxPhysics,
      actor0: PxRigidActor,
      localFrame0: PxTransform,
      actor1: PxRigidActor,
    ...
    static CreateConvexMesh(
      params: PxCookingParams,
      desc: PxConvexMeshDesc,
    ): PxConvexMesh;
    static CreateTriangleMesh(
      params: PxCookingParams,
      desc: PxTriangleMeshDesc,
    ): PxTriangleMesh;
    static CreateHeightField(desc: PxHeightFieldDesc): PxHeightField;
    static CookTriangleMesh(
      params: PxCookingParams,
      desc: PxTriangleMeshDesc,
      stream: PxOutputStream,
    ): boolean;
    static CookConvexMesh(
      params: PxCookingParams,
      desc: PxConvexMeshDesc,
      stream: PxOutputStream,
    ): boolean;
    static CreateDynamicFromShape(
      sdk: PxPhysics,
      transform: PxTransform,
      shape: PxShape,
      density: number,
    ...
    static CreateDynamic(
      ...
      material: PxMaterial,
      density: number,
      shapeOffset?: PxTransform,
    ): PxRigidDynamic;
    static CreateKinematicFromShape(
      sdk: PxPhysics,
      transform: PxTransform,
      shape: PxShape,
      density: number,
    ...
    static ScaleRigidActor(
      actor: PxRigidActor,
      scale: number,
      scaleMassProps: boolean,
    ): void;
    static IntegrateTransform(
      curTrans: PxTransform,
      linvel: PxVec3,
      angvel: PxVec3,
      timeStep: number,
      result: PxTransform,
  ...
  class PxVehicleCommandNonLinearResponseParams {
    ...
    clear(): void;
    addResponse(
      commandValueSpeedResponses: PxVehicleCommandValueResponseTable,
    ): boolean;
  ...
  class PxVehicleTireForceParamsExt {
    static setFrictionVsSlip(
      tireForceParams: PxVehicleTireForceParams,
      i: number,
      j: number,
      value: number,
    ): void;
    static setLoadFilter(
      tireForceParams: PxVehicleTireForceParams,
      i: number,
      j: number,
      value: number,
  ...
  class PxVehicleTopLevelFunctions {
    ...
    static VehicleComputeSprungMasses(
      nbSprungMasses: number,
      sprungMassCoordinates: PxArray_PxVec3,
      totalMass: number,
      gravityDirection: PxVehicleAxesEnum,
      sprungMasses: PxArray_PxReal,
    ): boolean;
    static VehicleUnitCylinderSweepMeshCreate(
  ...
  class SupportFunctions {
    ...
    static PxArticulationReducedCoordinate_getMinSolverPositionIterations(
      articulation: PxArticulationReducedCoordinate,
    ): number;
    static PxArticulationReducedCoordinate_getMinSolverVelocityIterations(
      articulation: PxArticulationReducedCoordinate,
    ): number;
  }
