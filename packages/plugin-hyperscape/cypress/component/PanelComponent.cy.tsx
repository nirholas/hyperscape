...
class QueryClient {
  constructor(options?: {
    defaultOptions?: { queries?: { retry?: boolean } };
  }) {
    // Mock implementation
  }
}
...
describe("PanelComponent Tests", () => {
    ...
    it("should fetch and display time in panel", () => {
      ...
      cy.mount(
        React.createElement(QueryClientProvider, {
          client: queryClient,
          children: React.createElement(PanelComponent, {
            agentId: "test-panel-123",
          }),
        }),
      );
  ...
  describe("Panel Integration", () => {
    it("should integrate with agent UI system", () => {
      ...
      cy.mount(
        React.createElement(AgentUIContainer, { agentId: "ui-test-agent" }),
      );
    ...
    it("should handle panel switching", () => {
      ...
      const mockPanels = [
        ...panels,
        {
          ...
          path: "second",
          component: ({ agentId }: { agentId: string }) =>
            React.createElement("div", null, `Second panel for ${agentId}`),
          icon: "Settings",
          public: false,
          shortLabel: "Second",
        },
