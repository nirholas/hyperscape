    ...
    persist(
      subscribeWithSelector(
        immer((set, get) => ({
          ...
          setShowRetextureModal: (show) =>
            set((state) => {
              state.showRetextureModal = show;
            }),

          setShowRegenerateModal: (show) =>
            set((state) => {
            ...
            return assets.filter((asset) => {
              ...
              if (state.materialFilter) {
                ...
                // For variant assets with baseMaterial
                  ...
                  asset.metadata.baseMaterial
                ) {
                  if (asset.metadata.baseMaterial !== state.materialFilter)
                    return false;
                }
