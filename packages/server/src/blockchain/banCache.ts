...
export class BanCache {
  ...
  constructor(provider: ethers.Provider) {
    this.contract = new ethers.Contract(BAN_MANAGER_ADDRESS, BAN_MANAGER_ABI, provider);
  }
  ...
  async initialize(): Promise<void> {
    ...
    // Query past bans
    const networkBans = await this.contract.queryFilter('NetworkBanApplied', fromBlock);
