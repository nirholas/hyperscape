...
import type { SpawnArea } from "../../types/entities/components";
import { calculateDistance2D } from "../game/EntityUtils";
...
export class CircularSpawnArea implements SpawnArea {
  ...
  getRandomPosition(): Vector3 {
    ...
    const yOffset =
      this.maxHeight > 0 ? (Math.random() - 0.5) * this.maxHeight * 2 : 0;
