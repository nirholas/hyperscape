...
//       // Uses same reliable setTimeout approach as right-click menu actions
//       if (target.type === "npc") {
//         event.preventDefault();
//         const localPlayer = this.world.getPlayer();
...
//           // Calculate distance for walk timing
//           const distance = this.calculateDistance(
//             localPlayer.position,
//             target.position,
//           );
//           const interactRange = 2.0; // Chebyshev distance for interaction

//           // Minimum delay even when already in range to avoid race conditions
//           const minDelay = 50;
...
//           // Calculate delay based on distance (same formula as right-click)
//           const actionDelay =
//             distance > interactRange
//               ? Math.min(distance * 400, 3000)
//               : minDelay;

//           // Trigger service after delay (reliable setTimeout approach)
//           setTimeout(() => {
//             if (this.world.network?.send) {
//               if (service === "bank") {
