...
import type {
  GeometryCacheItem as CacheItem,
...
export function geometryToPxMesh(
  ...
  if (
    ...
    // deinterleave!
    interface InterleavedAttributeWithGetComponent
      extends THREE.InterleavedBufferAttribute {
    ...
    const attrWithGetComponent =
      interleavedAttribute as InterleavedAttributeWithGetComponent;
