...
export const AVATAR_OPTIONS: AvatarOption[] = [
  {
    id: "male-01",
    name: "Male Avatar 01",
    url: "asset://avatar-male-01.vrm",
    previewUrl: "http://localhost:8080/avatar-male-01.vrm",
    description: "Standard male humanoid avatar",
  },
  {
    id: "male-02",
    name: "Male Avatar 02",
    url: "asset://avatar-male-02.vrm",
    previewUrl: "http://localhost:8080/avatar-male-02.vrm",
    description: "Standard male humanoid avatar",
  },
  {
    id: "female-01",
    name: "Female Avatar 01",
    url: "asset://avatar-female-01.vrm",
    previewUrl: "http://localhost:8080/avatar-female-01.vrm",
    description: "Standard female humanoid avatar",
  },
  {
    id: "female-02",
    name: "Female Avatar 02",
    url: "asset://avatar-female-02.vrm",
    previewUrl: "http://localhost:8080/avatar-female-02.vrm",
    description: "Standard female humanoid avatar",
  },
];
